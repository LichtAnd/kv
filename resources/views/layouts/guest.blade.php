                        ...
                        <div class="grid w-full lg:grid-cols-3">
                            <div>
                                ...
                                <p class="mt-[1em] text-base text-secondary-100">
                                    <a class="flex items-center" href="mailto:hallo@katjaveit.com" target="_blank">
                                        <svg class="fill-current w-[1.5rem] h-[1.5rem] text-secondary-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <!-- Icon: Email -->
                                ...
                                <p class="mt-[1em] text-base text-secondary-100">
                                    <a class="flex items-center" href=" https://wa.me/491731618044" target="_blank">
                                        <svg class="fill-current w-[1.5rem] h-[1.5rem] text-secondary-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <!-- Icon: Whatsapp -->
                            ...
                            <div class="mt-[2em] lg:mt-0">
                                ...
                                <ul class="mt-[1em] list-inside list-disc text-secondary-300">
                                    <li><a class="text-base text-secondary-100 hover:underline" href="/">Startseite</a></li>
                                    <li><a class="text-base text-secondary-100 hover:underline" href="/yoga">Yoga</a></li>
                                    <li><a class="text-base text-secondary-100 hover:underline" href="/familiencoaching">Coaching</a></li>
                                    <li><a class="text-base text-secondary-100 hover:underline" href="/katja-veit">Über Katja Veit</a></li>
                                    <li><a class="text-base text-secondary-100 hover:underline" href="/kontakt">Kontakt</a></li>
                                    <li><a class="text-base text-secondary-100 hover:underline" href="/buchung">Buchung</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="mt-[2em] lg:mt-0">
                                ...
                                <div class="mt-[1em] flex">
                                    <a class="flex items-center" href="mailto:hallo@katjaveit.com" target="_blank">
                                        <svg class="fill-current w-[2rem] h-[2rem] text-secondary-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <!-- Icon: Facebook-->
                                    ...
                                    <a class="flex items-center" href="https://www.instagram.com/katja_veit_/" target="_blank">
                                        <svg class="fill-current w-[2rem] h-[2rem] text-secondary-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <!-- Icon: Instagram-->
